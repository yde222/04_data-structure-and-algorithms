...
public class B_SelectionSort {
    ...
    /* 문제 : n개의 정수가 주어졌을 때 선택 정렬 알고리즘을 사용하여 오름차순 정렬 */
    ...
    public static void main(String[] args) {
        ...
        try (BufferedReader br = new BufferedReader(new InputStreamReader(System.in))) {
            ...
            int length = Integer.parseInt(br.readLine()); // 문자열로 받은걸 int형으로 변경. 파싱

            IntStream intStream = Arrays.stream(br.readLine().split(" ")).mapToInt(Integer::parseInt);
            //mapToInt : int형으로 바꿀건데
