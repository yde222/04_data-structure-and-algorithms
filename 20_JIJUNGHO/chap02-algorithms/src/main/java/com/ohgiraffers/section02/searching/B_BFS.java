 ...
 * 시작 노드에서 출발해서 시작 노드를 기준으로 가까운 노드를 먼저 방문하면서 탐색하는 알고리즘
 * */
...
public class B_BFS {
    ...
    public static int soluciont(String input) throws IOException {
    ...
    /***
     * 지렁이가 심어질 때마다 한번 씩 동작하는 bfs 메소드
     * @param x
     * @param y
     */
