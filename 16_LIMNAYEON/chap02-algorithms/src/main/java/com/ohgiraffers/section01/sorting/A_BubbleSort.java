...
//        System.out.println("Array.toString() = " + Arrays.toString(arr));

        try (BufferedReader br = new BufferedReader(new InputStreamReader(System.in))) {

            int length = Integer.parseInt(br.readLine());

            IntStream intStream = Arrays.stream(br.readLine().split(" ")).mapToInt(x -> Integer.parseInt(x));      //mapToInt(Integer::parseInt);
